                ...
                <form action="{{ route('admin.services.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3"></textarea>
                        </div>
                        ...
                        <div x-data="{ activities: [''] }">
                            <x-input-label :value="__('Rincian Kegiatan (Itinerary)')" />
                            <template x-for="(activity, index) in activities" :key="index">
                                <div class="flex mt-2">
                                    <x-text-input name="activities[]" x-model="activities[index]" type="text" class="block w-full" placeholder="Contoh: Sesi Pembukaan, Workshop Day 1..." />
